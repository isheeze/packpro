(() => {
  ...
  // extensions/packaging-inventory/src/BlockExtension.jsx
  var import_react17 = __toESM(require_react());

  // extensions/packaging-inventory/src/utils.js
  var getAppId = () => __async(void 0, null, function* () {
    let appId = yield makeGraphQLQuery(
      `
        query {
    ...
    return yield appId.data.currentAppInstallation.id;
  });
  var removeObjectsWithFalseStatus = (obj) => {
  ...
  var getAllPackagings = () => __async(void 0, null, function* () {
    let appId = yield getAppId();
    let allPackagings = JSON.parse((yield makeGraphQLQuery(`query {
  ...
  var getActivePackagings = () => __async(void 0, null, function* () {
    let appId = yield getAppId();
    let allPackagings = JSON.parse((yield makeGraphQLQuery(`query {
        appInstallation(id: "${appId}") {
            metafield(namespace: "packaging_inventory",key: "packagings"){
  ...
  var updatePackagings = (packagings) => __async(void 0, null, function* () {
    let appId = yield getAppId();
    let allPackagings = yield getAllPackagings();
    Object.keys(packagings).map((key) => allPackagings = __spreadProps(__spreadValues({}, allPackagings), { [key]: __spreadProps(__spreadValues({}, allPackagings[key]), { quantity: Number(allPackagings[key].quantity) - Number(packagings[key].usedQuantity) }) }));
    let res = yield makeGraphQLQuery(`
  ...
  function updateUsedPackagings(id, newQuantities) {
    return __async(this, null, function* () {
  ...
  function getUsedQuantities(id) {
    return __async(this, null, function* () {
      var _a, _b, _c;
      const res = (_c = (_b = (_a = yield makeGraphQLQuery(
        `
    query Order($id: ID!) {
      order(id: $id) {
    ...
    `,
        { id }
      )) == null ? void 0 : _a.data) == null ? void 0 : _b.order) == null ? void 0 : _c.metafield;
      if (res) {
  ...
  function App() {
    ...
    const [packagings, setPackagings] = (0, import_react17.useState)({});
    const [newQuantity, setNewQuantity] = (0, import_react17.useState)({});
    const [prevQuantity, setPrevQuantity] = (0, import_react17.useState)({});
    (0, import_react17.useEffect)(() => {
      (function getProductInfo() {
        return __async(this, null, function* () {
          setPackagings(yield getActivePackagings());
          let usedQuantity = yield getUsedQuantities(data.selected[0].id);
          setPrevQuantity((prevQuant) => __spreadValues(__spreadValues({}, prevQuant), usedQuantity));
          setNewQuantity((prevQuant) => __spreadValues(__spreadValues({}, prevQuant), usedQuantity));
          setPackagings((prevState) => {
            const newState = __spreadValues({}, prevState);
    ...
    const onSubmit = () => __async(this, null, function* () {
      yield updatePackagings(packagings);
      yield updateUsedPackagings(data.selected[0].id, newQuantity);
    });
    const onReset = () => __async(this, null, function* () {
    });
    return loading ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(InlineStack2, { blockAlignment: "center", inlineAlignment: "center", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ProgressIndicator2, { size: "large-100" }) }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(AdminBlock2, { title: "Packaging", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Form2, { id: `issues-form`, onSubmit, onReset, children: Object.values(packagings).map(
      ({ id, title, description, quantity }, index) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_react17.Fragment, { children: [
          ...
          InlineStack2,
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Box2, { inlineSize: "53%", children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { inlineSize: "100%", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { fontWeight: "bold-300", textOverflow: "ellipsis", children: title }) }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { inlineSize: "100%", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { fontWeight: "normal", textOverflow: "ellipsis", children: description }) })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { inlineSize: "22%", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                NumberField2,
                {
                  ...
                  onChange: (newVal) => {
                    setNewQuantity((prev) => __spreadProps(__spreadValues({}, prev), { [id]: newVal }));
                    setPackagings((prev) => __spreadProps(__spreadValues({}, prev), { [id]: __spreadProps(__spreadValues({}, prev[id]), { usedQuantity: Number(newVal) - Number(prevQuantity[id] || 0) }) }));
                  }
                }
              ) }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Box2, { inlineSize: "25%", children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { inlineSize: "100%", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { fontWeight: "bold", textOverflow: "ellipsis", children: "Inventory" }) }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { inlineSize: "100%", children: Number(quantity || 0) + Number(prevQuantity[id] || 0) - Number(newQuantity[id] || 0) > 15 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Badge2, { tone: "info", children: [
                  Number(quantity || 0) + Number(prevQuantity[id] || 0) - Number(newQuantity[id] || 0),
                  " remaining"
                ] }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Badge2, { tone: "critical", children: [
                  Number(quantity || 0) + Number(prevQuantity[id] || 0) - Number(newQuantity[id] || 0),
                  " remaining"
                ] }) })
              ] })
...
//# sourceMappingURL=packaging-inventory.js.map
